    ...
    <div className="space-y-4">
      ...
      <div className="bg-[#0e1017] border border-white/[0.08] rounded-2xl p-5 text-white shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 bg-neutral-950 px-3 py-2 rounded-xl border border-white/[0.06] text-xs text-neutral-400 font-mono">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 font-mono">
        ...
        <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-4 shadow-xs flex items-center gap-3.5">
          ...
          <div>
            <div className="text-[10px] text-neutral-500 uppercase">Récord Calificado</div>
        ...
        <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-4 shadow-xs flex items-center gap-3.5">
          <div className="w-11 h-11 rounded-xl bg-white/[0.06] border border-white/[0.1] flex items-center justify-center text-neutral-300 shrink-0">
            <TrendingUp className="w-5 h-5" />
          </div>
          <div>
            <div className="text-[10px] text-neutral-500 uppercase">Unidades Ganadas (Flat 1u)</div>
            <div className="text-sm font-black text-emerald-400 mt-0.5">+{panel.units_flat.toFixed(1)} Unidades</div>
            <div className="text-[10px] text-neutral-400">ROI +6.4% sostenido</div>
          </div>
        </div>
        ...
        <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-4 shadow-xs flex items-center gap-3.5">
          ...
          <div>
            <div className="text-[10px] text-neutral-500 uppercase">Racha Actual & L10</div>
            <div className="text-sm font-black text-white mt-0.5">{panel.last_10}</div>
            <div className="text-[10px] text-neutral-400">Racha máxima: {panel.best_streak}W</div>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs text-neutral-300">
            ...
            <tbody className="divide-y divide-white/[0.04]">
              {gradedGames.map((g) => (
                <tr key={g.game_pk} className="hover:bg-neutral-950/60 transition-colors">
                  ...
                  <td className="py-2.5 px-3">
                    ...
                    <div className="text-[10px] text-neutral-500">{g.venue_name}</div>
                  </td>
                  <td className="py-2.5 px-3 text-neutral-400 text-[11px]">
                    <div>{g.away_sp}</div>
                    <div className="text-neutral-600">vs {g.home_sp}</div>
                  </td>
                  <td className="py-2.5 px-3">
                  ...
                  <td className="py-2.5 px-3">
                    <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold border ${
                      g.conf === 'MEDIUM' ? 'bg-white/[0.06] text-neutral-300 border-white/[0.1]' : 'bg-neutral-800 text-neutral-400 border-neutral-700'
                    }`}>
                      {g.conf}
                    </span>
                  </td>
