    ...
    <div className="space-y-4 font-mono">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-bold px-2 py-0.5 rounded-full bg-white/[0.06] text-neutral-300 border border-white/[0.1] flex items-center gap-1">
          ...
          <div className="flex items-center gap-1 bg-neutral-950 p-1 rounded-xl border border-white/[0.06] self-start md:self-center text-xs">
            <button
            ...
            >
              <BarChart2 className="w-3 h-3 text-neutral-300" />
              Analista
            </button>
          </div>
        </div>
      ...
      <div className="bg-[#0e1017] border border-white/[0.08] rounded-2xl p-4 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs font-sans">
          ...
          <div className="p-3.5 rounded-xl bg-neutral-950 border border-white/[0.06] space-y-1">
          ...
          <div className="p-3.5 rounded-xl bg-neutral-950 border border-white/[0.06] space-y-1">
            <div className="font-bold text-neutral-300 flex items-center gap-1.5 text-xs font-mono">
      ...
      {viewMode === 'easy' ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-4 shadow-xs flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-[10px] text-neutral-500 font-bold mb-1 uppercase">
            ...
            <p className="text-[10px] text-neutral-500 mt-2.5 pt-2.5 border-t border-white/[0.04] font-sans">
              Medido en <strong>{m.n.toLocaleString()} partidos</strong> de prueba.
            </p>
          </div>

          <div className="bg-[#0e1017] border border-white/[0.14] rounded-xl p-4 shadow-xs flex flex-col justify-between ring-1 ring-white/[0.08]">
            <div>
              <div className="flex items-center justify-between text-[10px] font-bold mb-1 uppercase">
                <span className="text-white">Confianza Alta</span>
                <span className="text-black bg-white px-1.5 py-0.2 rounded font-black text-[9px]">65%+</span>
              </div>
              <div className="text-2xl font-black text-white mt-1">
                {(m.acc_conf_65plus * 100).toFixed(1)}%
              </div>
              <div className="text-[10px] font-semibold text-neutral-300 mt-1">
          ...
          <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-4 shadow-xs flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-[10px] text-neutral-500 font-bold mb-1 uppercase">
                ...
                <span className="text-neutral-300 bg-white/[0.06] px-1.5 py-0.2 rounded text-[9px]">Alta</span>
              </div>
              <div className="text-2xl font-black text-white mt-1">
                0.184 Brier
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-3.5 shadow-xs">
            <div className="flex items-center justify-between text-[10px] text-neutral-500 font-bold">
              ...
              <span className="text-neutral-600">n = {m.n}</span>
            </div>
            <div className="text-2xl font-black text-white mt-1">
          ...
          <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-3.5 shadow-xs">
            <div className="flex items-center justify-between text-[10px] text-neutral-500 font-bold">
              <span>LOG-LOSS</span>
              <span className="text-neutral-300">Menor es mejor</span>
            </div>
            <div className="text-2xl font-black text-white mt-1">
          ...
          <div className="bg-[#0e1017] border border-white/[0.08] rounded-xl p-3.5 shadow-xs">
            <div className="flex items-center justify-between text-[10px] text-neutral-500 font-bold">
              ...
              <span className="text-neutral-600">Ideal ~0.24</span>
            </div>
            <div className="text-2xl font-black text-neutral-300 mt-1">
              {m.brier.toFixed(4)}
            </div>
            <p className="text-[10px] text-neutral-500 mt-1 font-sans">
      ...
      <div className="bg-[#0e1017] border border-white/[0.08] rounded-2xl p-4 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
          ...
          <span className="text-[10px] text-neutral-400 bg-neutral-950 px-2 py-0.5 rounded border border-white/[0.06]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="p-3 rounded-xl bg-neutral-950 border border-white/[0.06] flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center mb-1 text-[10px]">
                <span className="font-bold text-neutral-400">CONFIANZA BAJA (50%–60%)</span>
                <span className="text-neutral-600">{m.n_conf_55_60} gms</span>
              </div>
              <div className="text-xl font-black text-white">
                {(m.acc_conf_55_60 * 100).toFixed(1)}%
              </div>
              <div className="h-1.5 bg-neutral-800 rounded-full mt-2 overflow-hidden">
                <div className="h-full bg-neutral-500" style={{ width: `${m.acc_conf_55_60 * 100}%` }}></div>
              </div>
            </div>
            <p className="text-[10px] text-neutral-500 mt-2.5 pt-1.5 border-t border-white/[0.04] font-sans">
          ...
          <div className="p-3 rounded-xl bg-neutral-950 border border-white/[0.06] flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center mb-1 text-[10px]">
                <span className="font-bold text-neutral-300">CONFIANZA MEDIA (60%–65%)</span>
                <span className="text-neutral-600">{m.n_conf_60_65} gms</span>
              </div>
              <div className="text-xl font-black text-white">
                {(m.acc_conf_60_65 * 100).toFixed(1)}%
              </div>
              <div className="h-1.5 bg-neutral-800 rounded-full mt-2 overflow-hidden">
                <div className="h-full bg-white" style={{ width: `${m.acc_conf_60_65 * 100}%` }}></div>
              </div>
            </div>
            <p className="text-[10px] text-neutral-500 mt-2.5 pt-1.5 border-t border-white/[0.04] font-sans">
          ...
          <div className="p-3 rounded-xl bg-neutral-950 border border-emerald-500/30 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center mb-1 text-[10px]">
