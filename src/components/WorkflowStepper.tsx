          ...
          return (
            <button
              ...
              className={`p-3 rounded-xl border text-left transition-all duration-200 relative flex flex-col justify-between ${
                isActive
                  ? 'bg-zinc-800/90 border-cyan-500/50 shadow-md ring-1 ring-cyan-500/20'
                  : 'bg-[#090b11]/70 border-white/[0.04] hover:border-white/15 hover:bg-zinc-900/60'
              }`}
            >
              <div className="flex items-center justify-between w-full mb-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xs font-bold tracking-tight ${isActive ? 'text-white' : 'text-zinc-300'}`}>
                    {step.title}
                  </span>
                </div>
                  ...
                  <span
                    className={`text-[10px] font-bold font-mono px-2 py-0.5 rounded-full ${
                      isActive
                        ...
                        : 'bg-zinc-900 text-zinc-500 border border-white/[0.04]'
                    }`}
                  >
                    {step.badge}
                  </span>
              ...
              <p className="text-[11px] text-zinc-400 font-normal leading-relaxed pl-8">
                {step.description}
              </p>
            </button>
          );
