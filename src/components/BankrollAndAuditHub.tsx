  ...
  return (
    <div className="space-y-4 font-mono">
      ...
      <div className="bg-[#0e1017] border border-white/[0.08] rounded-2xl p-2 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 shadow-xs">
        <div className="flex items-center gap-1.5 p-1 bg-zinc-950 rounded-xl border border-white/[0.06] text-xs">
          <button
            onClick={() => setSubTab('balance')}
            className={`px-3.5 py-1.5 rounded-lg font-bold flex items-center gap-2 transition-all ${
              subTab === 'balance'
                ? 'bg-zinc-800 text-emerald-300 shadow-xs border border-emerald-500/30'
        ...
        <div className="text-[11px] text-zinc-400 px-3 py-1 bg-zinc-950 rounded-xl border border-white/[0.06] flex items-center gap-2 self-start sm:self-center">
